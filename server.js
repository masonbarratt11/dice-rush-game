...
app.post('/api/match/:matchId/roll', (req, res) => {
  ...
  if (match.player1Wins >= 2 || match.player2Wins >= 2) {
    ...
    return res.json({
      matchComplete: true, winner, prize: prize.toFixed(2),
